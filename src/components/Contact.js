...
const Contact = () => {
  ...
  return (
    <section className="text-gray-600 body-font bg-gradient-to-b from-[#0D0221] via-[#141C2D] to-[#102552] ">
      <div className="px-3 py-5 mx-auto text-center  sm:mx-7 md:mx-12 lg:mx-32 xl:mx-56">
        ...
        <div className="flex flex-col gap-2 md:flex-row w-full mx-auto rounded-xl p-4 md:gap-7 lg:gap-9 lg:rounded-2xl xl:gap-10 border-4 border-gray-500">
