...
const Skills = () => {
  return (
    <section className="text-gray-100 body-font bg-gradient-to-b from-[#102552] via-[#141C2D] to-[#0D0221]">
      <div className="p-4 pt-0 mx-auto md:p-5 md:mx-20 lg:mx-32 xl:mx-56">
        ...
        >
          <h1 className="sm:text-4xl text-3xl font-medium mb-2 text-gray-300">
            Skills
          </h1>
          <p
            data-aos="zoom-in"
