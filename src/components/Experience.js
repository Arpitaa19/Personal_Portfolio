...
const Experience = () => {
  return (
    <section className="py-10 px-3 bg-gradient-to-b from-[#102552] via-[#141C2D] to-[#0D0221]">
      <div className="mx-auto max-w-6xl">
        <div id="experience" className="flex flex-col text-center mb-4 w-full ">
          <h1 className="text-3xl sm:text-4xl font-medium title-font mb-2  text-gray-300">
            Experience
          </h1>
          <p
            data-aos="zoom-in"
